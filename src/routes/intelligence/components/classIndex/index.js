  ...
  return (
    <div>
    {
        classTabs.map((item, index) => {
            return (
                <div key={`classList_`+index} style={{ marginTop: '35px', marginBottom: "69px", height: '300px', width: '277px', display: 'inline-block', marginLeft: index === 0 ? '0px' : '30px', textAlign:'left' }}>
