...
const TrainIndex = (props) => {
    ...
    const bannerList = [
        {
            url: require('./img/u491.jpg'),
        },
        {
            url: require('./img/u527.jpg'),
        },
        {
            url: require('./img/u528.jpg'),
        },
        {
            url: require('./img/u529.jpg'),
        }
    ]
    const planList = [
        { name: '实训计划', url: require('./img/u572_div.JPG') },
        { name: '历史实训成绩查询', url: require('./img/u565_div.JPG') },
        { name: '实训打卡', url: require('./img/u568_div.JPG') },
        { name: '实训自评', url: require('./img/u561_div.JPG') },
    ]
    const achivList = [
    ...
    const cpyPicList = [
        ...
        { url: require('./img/u529.jpg') },
        { url: require('./img/u527.jpg') },
        { url: require('./img/u543.jpg') }, { url: require('./img/u528.jpg') },
        { url: require('./img/u529.jpg') },
        { url: require('./img/u527.jpg') },
        { url: require('./img/u543.jpg') },
    ]
    const basePicList = [
        { url: require('./img/u528.jpg'), name: "优秀校内基地" },
        { url: require('./img/u529.jpg'), name: "优秀校内基地" },
        { url: require('./img/u527.jpg'), name: "优秀校内基地" },
        { url: require('./img/u543.jpg'), name: "优秀校内基地" },
    ]
    return (
        <div className="App">
            ...
            <div className="body">
                ...
                <div className="train-plan">
                    {planList.map((item, index) => {
                        return <div key={index} style={{ width: "280px", height: "118px", position: "relative" }}><img src={item.url} style={{ width: "280px", height: "118px" }} alt=""></img><div style={{ width: "280px", position: "absolute", top: "0", left: "0", fontSize: "30px", color: "#fff", lineHeight: "118px", textAlign: "center" }}>{item.name}</div></div>
                    })}
                </div>
