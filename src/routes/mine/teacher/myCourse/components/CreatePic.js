...
import { getUploadUrl, savaFile } from 'apis/course';
...
const CreatePic = (props = {}) => {
  ...
  return (
    <div className="create-pic">
      ...
      <Row>
        <Col offset={9}>
          {/* <Button type="primary" htmlType="submit" onClick={commitUpload}>保存</Button> */}
          <Button type="primary" htmlType="submit" onClick={commitUpload}>下一步</Button>
          <Button>取消</Button>
        </Col>
      </Row>
